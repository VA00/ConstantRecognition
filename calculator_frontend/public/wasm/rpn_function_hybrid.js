...
function findWasmBinary() {
  return locateFile('rpn_function_hybrid.wasm');
}
...
var _search_RPN_hybrid = Module['_search_RPN_hybrid'] = makeInvalidEarlyAccess('_search_RPN_hybrid');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['search_RPN_hybrid'] != 'undefined', 'missing Wasm export: search_RPN_hybrid');
  ...
  _search_RPN_hybrid = Module['_search_RPN_hybrid'] = createExportWrapper('search_RPN_hybrid', 6);
