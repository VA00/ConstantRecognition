...
import { ActiveWorker, Precision } from '../lib/types';
...
export function Sidebar({
  ...
  return (
    <>
      ...
      <button
        onClick={onToggle}
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-white dark:bg-[#1a1a1d] rounded-lg shadow-lg border border-gray-200 dark:border-[#2a2a2e]"
      ...
      `}>
        ...
        <div className="p-4 border-b border-gray-200 dark:border-[#2a2a2e]">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h1 className="font-semibold text-gray-900 dark:text-white text-base lg:text-sm">Constant Recognizer</h1>
              <p className="text-xs lg:text-[10px] text-gray-500 dark:text-gray-500">Jagiellonian University</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-4 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <span className="font-mono text-lg lg:text-sm font-bold text-gray-900 dark:text-white w-6 lg:w-4">{searchDepth}</span>
            </div>
            <p className="text-xs lg:text-[10px] text-gray-400 dark:text-gray-600">Higher = slower but more accurate</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <span className="font-mono text-lg lg:text-sm font-bold text-gray-900 dark:text-white w-12 lg:w-6">
                {autoThreads ? 'Auto' : threadCount}
              </span>
            </div>
            <label className="flex items-center gap-2 text-sm lg:text-xs text-gray-600 dark:text-gray-400 cursor-pointer">
              <input
                type="checkbox"
                checked={autoThreads}
          ...
          <div className="space-y-3 lg:space-y-2">
            ...
            <button
              onClick={onReset}
              className="w-full px-4 py-3 lg:py-2 bg-gray-200 dark:bg-[#2a2a2e] hover:bg-gray-300 dark:hover:bg-[#3a3a3e] text-gray-700 dark:text-gray-300 font-medium rounded-lg transition-colors flex items-center justify-center gap-2 text-base lg:text-sm"
            >
              <svg className="w-5 h-5 lg:w-4 lg:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="p-4 border-t border-gray-200 dark:border-[#2a2a2e]">
          <a 
            ...
            className="flex items-center gap-2 text-sm lg:text-xs text-gray-500 dark:text-gray-500 hover:text-[#0066cc] transition-colors"
          >
            <svg className="w-5 h-5 lg:w-4 lg:h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"/></svg>
            View on GitHub
          </a>
        </div>
      </aside>
