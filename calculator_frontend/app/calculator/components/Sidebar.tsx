      ...
      <div className="flex-1 p-4 space-y-6 overflow-y-auto">
        ...
        <div className="space-y-2">
          {isCalculating && (
            <button
              onClick={onAbort}
              className="w-full px-4 py-2 bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
            >
          ...
          <button
            onClick={onReset}
            className="w-full px-4 py-2 bg-gray-200 dark:bg-[#2a2a2e] hover:bg-gray-300 dark:hover:bg-[#3a3a3e] text-gray-700 dark:text-gray-300 font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
