        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-3">
          ...
          <div className="flex gap-2">
            ...
            {isCalculating ? (
              ...
              <button
                onClick={onReset}
                className="px-4 py-3 bg-gray-200 dark:bg-[#2a2a2e] hover:bg-gray-300 dark:hover:bg-[#3a3a3e] text-gray-700 dark:text-gray-300 font-medium rounded-lg transition-colors flex items-center justify-center"
                title="Reset"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
